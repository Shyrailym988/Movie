...
extension MovieDetailsViewController {
    private func getMovieDetails() {
        AF.request("https://api.themoviedb.org/3/movie/\(movieId ?? 1))?api_key=6cec00dcb4dee1d05c74680b80965ec2&language=en-US", method: .get, parameters: [:]).responseJSON { [weak self] response in
